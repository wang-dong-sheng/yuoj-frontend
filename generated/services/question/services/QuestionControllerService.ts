...
questionQueryRequest: QuestionQueryRequest,
    ...
    /**
     * onlineDoQuestionSubmit
     * @param questionSubmitAddRequest questionSubmitAddRequest
     * @returns BaseResponse_ExecuteCodeResponse_ OK
     * @returns any Created
     * @throws ApiError
     */
    public static onlineDoQuestionSubmitUsingPost(
questionSubmitAddRequest: OnlineQuestionSubmitAddRequest,
): CancelablePromise<BaseResponse_ExecuteCodeResponse_ | any> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/question/online/question_sumit/do',
...
questionSubmitAddRequest: QuestionSubmitAddRequest,
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/question/question_sumit/do',
            body: questionSubmitAddRequest,
            errors: {
                401: `Unauthorized`,
                403: `Forbidden`,
