...
userAddRequest: UserAddRequest,
     ...
     * @throws ApiError
     */
    public static getAkSkByIdUsingGet(): CancelablePromise<BaseResponse_UserAkSkVO_> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/user/aksk',
            errors: {
...
userUpdateRequest: UserUpdateRequest,
     ...
     * @throws ApiError
     */
    public static updateAkSkByIdUsingGet(): CancelablePromise<BaseResponse_UserAkSkVO_> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/user/update/aksk',
            errors: {
                401: `Unauthorized`,
                403: `Forbidden`,
                404: `Not Found`,
